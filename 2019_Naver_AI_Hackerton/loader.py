...
#     waveformm, _ = torchaudio.load(filepath)
...
#     feat = specgram.squeeze()
#     feat = torch.FloatTensor(feat).transpose(0, 1)
#     del waveformm, _, specgram
...
class BaseDataset(Dataset):
    def __init__(self, wav_paths, script_paths, bos_id=1307, eos_id=1308, use_mel=False):
    ...
    def getitem(self, idx):
        if self.use_mel:
            # feat = self.audio_preprocess(self.wav_paths[idx])
